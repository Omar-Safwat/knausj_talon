...
default_alphabet = "air bat cap drum each fine gust harp sit jury crunch look made near owen pit quench red sonny trap urge vest whale plex yank zip".split(
    " "
)
